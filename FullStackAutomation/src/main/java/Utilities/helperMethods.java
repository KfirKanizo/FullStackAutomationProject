...
public class helperMethods extends commonOps
{
    ...
    {
//        imageScreenShot = new AShot().coordsProvider(new WebDriverCoordsProvider().takeScreenshot(driver, imageElement)); //win 7
        imageScreenShot = new AShot().takeScreenshot(driver, imageElement); //win 10
        try
        {
